...
> Per the [[Source and Interpretation Policy]]: "in Jungian terms, Lucius resembles the shadow" is a reading. "Lucius *is* Jung's shadow" would be overreach — the correspondence belongs to the framework, not the artist. Jung is also one pillar among several here (Bailey, Kabbalah, Hermeticism, Gurdjieff); the work is syncretic on purpose, and no single lens gets the master key. Notably, this guide does *not* lean on the rest of the Jungian toolkit — individuation, complexes, persona — because the work itself doesn't; where the songs say "mask," the page says mask.
