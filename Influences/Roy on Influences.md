---
title: Roy on Influences
type: concept
cssclasses: ["type-concept"]
status: published
confidence: grounded
source_basis: ["public interviews", "public posts", "official videos"]
---
# Roy on Influences

> **One-line reading.** Most artists let critics guess the reading list. Roy posts his — on the feed, on a bookshelf, on a hand-drawn board — and this page keeps the roster, with receipts and a warning label.

Naming an influence doesn't decode a song. What it does is *license a lens*: when Roy says he reads Gurdjieff, a Gurdjieff reading of his work stops being projection and becomes engagement with something the artist put on the table himself. This guide leans on that distinction constantly (see [[Source and Interpretation Policy]]), so the roster gets a page of its own.

## The named lineage

Across his 2025 feed Roy names the lineage out loud, with **Neville Goddard** as the lead and *his own mother as the first channel* — *"He who plants a seed believes in God."* Three of these figures do enough load-bearing work in the catalogue to have their own pages here:

- **[[Gurdjieff]]** — his most-named influence; the *"wake up"* frame, tattooed on his hand.
- **[[Carl Jung]]** — the shadow and its redemption; shelved publicly, posted to the Story.
- **[[Alice Bailey]]** — the Twelve Labors as soul-map; named, taught, annotated, and transcribed.
...
- **[Leonardo da Vinci](https://en.wikipedia.org/wiki/Leonardo_da_Vinci)** — the artist-engineer as a single job title.
