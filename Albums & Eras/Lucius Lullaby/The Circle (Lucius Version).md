...
A quick census of what's actually on the page: pronouns run **1 "I," 1 "you"** — this guide classes it a "mantra," the same pronoun-evacuation that runs through the album's quietest tracks. No verses, no chorus proper, no bridge. Just the phrase, looped, going nowhere — which is the point of a loop.
...
> This guide frames the reduction as a clean set of four inversions of the original Circle doctrine — worth having explicitly, because each maps a live pole of the mythology:
