...
- **A note on Bhasker.** His credit isn't only a metadata name. The full [[Superhuman]] (track 6), which this interlude feeds, began with Jeff Bhasker in 2012, was worked on with Michael Brun, and came together with Linus (per Roy's press). Bhasker appears on both the interlude and track 6, so his presence is a genuine composition-history anchor. *Subject to Flooding* itself was built across roughly 2012–2018, Roy's "wilderness years," with producers S1 (Larry Griffin Jr.), Linus, and Matt Pauling. (No per-track producer credit is on file for track 5 specifically; the engineering team is documented album-wide, not clip-by-clip.)
