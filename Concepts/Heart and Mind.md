...
> In this guide's Kabbalistic reading, the two poles can be placed on the Tree of Life: [[Roy]] at Netzach (Venus: love, feeling, art, devotion) facing [[Sir Lucius]] at Hod (Mercury: analysis, speech, framing, cleverness). Between and above them, Tiferet, the Sun's station, stays unoccupied: the heart-center both of them approach, an integration horizon rather than a seat anyone has taken. [[SOL]] reads at home there. The maze draws this same map as animals: in the [[Hall of Mirrors]] bestiary the fox, captioned *"Michael the Fox (who is a scientist)"* and holding the ☿ Mercury glyph, is keyed to Hod's number (its room's code is the numeral 8), while *"Venus the Dove"* holds the Netzach seat, so the doctrine's two poles hang in the gallery as a matched animal pair. Between them on the board, rung 6 of Roy's handwritten emanation list, the unoccupied center, reads *"[[Symbols/The Mirror|The Mirror]] of the Sun and the Heart."* Whether the fox and the dove are meant as the two character-poles is held as a question, not a verdict; the drawings name neither figure.
>
