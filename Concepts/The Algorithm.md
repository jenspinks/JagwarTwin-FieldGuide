...
> Roy set the word down in writing years before Lucius said it on camera. On the "I'm 33" board, the cell marked **Rhythm** reads: *"Everything repeats itself in rhythmic cycles as if the code of reality is operating on an algorithm."* The word set against cyclic repetition, in 2021.
>
...
> Then the theatrical argument replayed itself in real life. As *Welcome to the Circus*, the most deliberately engineered song in the catalogue, began breaking out, Roy conceded it, speaking as himself: *"It's actually wild what welcome to the circus is doing right now"* and *"I guess Lucius was right again."*
>
