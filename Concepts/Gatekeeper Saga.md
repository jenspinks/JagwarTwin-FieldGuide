...
> **One-line reading.** For four months a real record label blocked a real song, and Roy narrated the whole fight to his Discord as a Harry Potter serial — until the label "gave Dumbledore a sock" and the song went free. It's the catalogue's gatekeeping critique, performed live, as a bit.

Every theory page in this guide says some version of "the Circus decides what gets seen." The Gatekeeper Saga is the receipts: the one stretch where the machinery the songs describe operated on a song *in public*, in real time, with the artist live-blogging it in wizard-speak.

## At a glance

- **When** — November 2024 → February 28, 2025 (public Discord, running commentary).
- **The song** — [[dumbledore]], codename and eventual title; Roy's stated read: *"it's a love song"* — the mentor register, not plot.
- **The players** — Roy; Michael Morgan (co-narrator, house-elf correspondent); "the gatekeepers" (the label); the fellow *"potter heads and wizard nerds."*
- **Confidence** — grounded throughout: public Discord posts, a dated release, a blockchain drop.
...
The label cast as Lucius Malfoy, the song as Dobby, freedom by sock. On February 28, 2025, *dumbledore* released — on the very label the saga had been jousting with, in two versions, one of them literally titled *DARK ARTS*.

## Why it matters

- **The critique, enacted.** Lucius's whole thesis — that the machine only amplifies what feeds it — got demonstrated on an actual release. The saga is [[Welcome to the Circus]] as lived experience, with jokes.
- **The tone is the teaching.** Roy fought a months-long industry battle without a single bitter post: the fight conducted as play. The comic register isn't avoidance — it's the same wise-fool disguise the song itself runs on (see [[The Fool]]).
