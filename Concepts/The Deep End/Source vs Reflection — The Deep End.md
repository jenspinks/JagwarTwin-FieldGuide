---
title: Source vs Reflection — The Deep End
type: concept
...
> **One-line reading.** Across these older maps the diagnosis holds: reflected light stays faithful while it serves its source, and becomes a trap when a vessel claims to be that source. The traditions disagree on the outcome.

These are the older maps behind [[Concepts/Source vs Reflection|Source vs Reflection]]: the sun and moon on the Tree of Life, the breaking of the vessels, the two kinds of nothing, the mirror's tricks, the doubles, and the traditions behind them, plus the public objects that carry them into the work: a creation poem, a machine moon, and two title cards. The maps are comparisons the material permits, held loosely, and the main page stands without them.

[[Concepts/Source vs Reflection|Back to the core reading]] · Open any drawer for the full explanation.

---

> [!map]- The cast, by what their light does<br><span class="jt-drawer-summary">In this reading nearly everyone mediates, but each figure blesses, keeps, seeks, waits, or counterfeits.</span>
...
> [!map]- The Sun and Its Hangers-On<br><span class="jt-drawer-summary">Held as Kabbalistic resonance: the Sun is the source, and nobody owns the Moon.</span>
...
>
> The **moon**'s stations (Malkhut + Yesod) hold the lunar vessel-work of receiving and reflecting, and nobody *owns* the Moon or stands there for good: Roy, Mary and Lucius each take up its role at times. Inside the diminished-moon tradition, and only there, "the moon trying to become a sun" named an arc of restoration resolving into "reclaim your crown" (the moon once sun-equal, made to shrink, promised return; Isaiah 30:26, "the light of the moon shall become as the light of the sun"; Cordovero's *atarah*, where Malkhut becomes the crown on ascent). Outside that tradition the phrase does not hold: *The Song of the Sun & the Moon* has the two bodies singing **together**, so restoration reads as relationship, not promotion. When Roy takes up the lunar work he carries the moon's *mode*; when [[Mary]] does, she carries its *personhood and theology* (Shekhinah, reflected light, exile then return).
>
> In this map [[Sir Lucius]] holds no lasting place at the Moon and takes no Venus. His clean correspondence is Hod/Mercury, intellect and speech. The one thread that reaches him is a *name-echo*, not a planet: the *lucifer*, the light-bringer, the herald routinely mistaken for the dawn it only announces (Isaiah 14:12). That morning-star resonance stays a footnote on the name, never his planet or character-symbol, because Venus/Netzach is Roy's. So the reflecting side keeps one living body, the Moon, nobody's deed and everybody's teacher, and the Sun is the true light it orbits and is not. The cure is identical in every register: re-subordinate the reflected light to its source, "my mind must serve my heart."
>
> The whole apparatus is syncretic and held as resonance; see [[Kabbalah - The Tree of Life]].

> [!lore]- One Become Two (the *Think Like A Tree Growing Down* panel)<br><span class="jt-drawer-summary">In the creation poem the self splits to see itself, risking loss in its reflection.</span>
> A [[Hall of Mirrors/Hall of Mirrors|Hall of Mirrors]] artifact states the source-and-reflection split *as a creation myth*. The self divides in order to see itself, and the second term it becomes is "You": "I was just me… I wanted to see myself and where I could go. I spoke the words 'One become Two.' Then I was in reverse… and I became You." This grounds *why* reflection exists at all, and it reframes the antagonist: Lucius is not an evil origin but the **risk built into reflection itself**, the image that can forget it was only ever the One looking back. (A single point can't know itself. It has position, but no structure, so the split isn't a fall, it's the price of sight. The acorn has to forget it's a tree to become one.)
>
> The same leaf runs on: "point with no beginning / wheel inside a wheel / Half a crown in my hand / [[Symbols/The Moon|The Moon]] Machine keeping time / I woke up in my shadow," where "The Moon Machine keeping time" fuses the moon (reflector) with the machine (apparatus) in a single phrase, and "I woke up in my shadow" is the whole awakening-inside-the-reflection image in five words. The fuller myth is not confined to the maze: it surfaces as a released song, [[Another Way II Heaven]] (*33*, 2022, written by Roy alone), near-identical to the board poem that carries it: "A Darkness and a Light… when we crashed and came together, A Sun was born inside. Next there were 4 — Process & Time… But one day We'll get back together and see The Great Design." That single passage is at once the Roy/Lucius split, the breaking of the vessels, and the birth of the wordless love: "A Sun was born inside" reads as the making of the sun the catalogue later names [[SOL]], the Song of Love (*sol* = sun). Held as a reading, not an equation.

> [!map]- The Shard That Forgot It Was a Shard<br><span class="jt-drawer-summary">In a Kabbalistic comparison, Lucius reads as the shard that claims to be the source.</span>
...
> [!reading]- Two Kinds of Nothing<br><span class="jt-drawer-summary">“Nothing” can be a shell sealed against the source, or clear glass letting light through.</span>
...
> [!reading]- The Flip and the Funhouse<br><span class="jt-drawer-summary">The mirror reads as trap and tool: its flips and distortions can also reveal what’s hidden.</span>
...
> [!mask]- The Reflection Gets Up and Walks<br><span class="jt-drawer-summary">SARAVI reflected the source, Lucius reflects the algorithm: a rhyme, not an equation.</span>
