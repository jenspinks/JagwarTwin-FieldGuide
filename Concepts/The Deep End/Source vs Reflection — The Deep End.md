...
Across these older maps the diagnosis holds: reflected light stays faithful while it serves its source, and becomes a trap when a vessel claims to be that source. The traditions disagree on the outcome.
...
> [!map]- The Shard That Forgot It Was a Shard<br><span class="jt-drawer-summary">The Kabbalistic vessel offers a comparison for Lucius: something made to carry light ends by claiming to be its source.</span>
...
> [!reading]- Two Kinds of Nothing<br><span class="jt-drawer-summary">The same “nothing” can be a hollow shell sealed against the source, or a clear, open glass that lets the light through.</span>
...
> [!mask]- The Reflection Gets Up and Walks<br><span class="jt-drawer-summary">SARAVI reflected the source and Lucius reflects the algorithm: one mirror function with opposite charge, a rhyme, not an equation.</span>
...
> [!props]- The Moon Had Gears<br><span class="jt-drawer-summary">In the Sir Rabbit poem, the Violet Moon turns out to be a machine, which reads as enchantment hiding an apparatus.</span>
...
> [!feed]- Fresh From the Feed<br><span class="jt-drawer-summary">The posts keep returning to the world as a reflection, forms that deceive, light as identity, and the artist stepping aside.</span>
