...
> **One-line reading.** A song, mask, or mirror can help you recognize yourself, or trap you in an image. This guide reads the difference as whether the reflection serves the living self or starts replacing it.

> [!gist] I just want to be a mirror
> Roy offers this as a method, not a mood, and he has repeated it for years: "more and more I realize that a song is a mirror," "we're all really mirrors to each other if we look." That last one predates the [[Hall of Mirrors/Hall of Mirrors|Hall of Mirrors]] site by four years.
>
...
* [[Symbols/El Roi|El Roi]] (אל ראי, "the God who sees me," Genesis 16:13), marked on Sir Lucius's throat: the reflection-figure wearing the name of the divine seer on the very throat that keeps insisting "you don't know me."
...
> [!map]- The quiet part, said out loud<br><span class="jt-drawer-summary">The project is a hall of mirrors, and the posts keep the reflection's origin not-evil.</span>
...
>
> Two markings carry the frame, and they are not the same kind of thing. Sir Lucius wears El Roi at the throat as part of the mask (the balance of the evidence reads it as makeup, not ink on Roy's body). Roy wears [[Concepts/The Empty Mirror|The Empty Mirror]] at the wrist as an actual tattoo, and glosses it as "about looking at yourself in the mirror and seeing nothing."
>
...
>
> Substitution comes in three gears. **Transmission**: the reflection stays servant to the source, pointing through itself. **Distortion**: the reflection forgets it is a reflection, the funhouse pane, the engineered dream, still a failed image, not yet a rival. **Usurpation**: the reflection claims to *be* the source. That third gear is [[Sir Lucius]], not a smudged copy but a rival center, and it is why he can't be fixed like a dirty mirror. A rival center has to be re-subordinated, stopped, or redeemed, and the cure the work keeps stating is the first of those: "my mind must serve my heart."
>
...
> [!reading]- The song behind the song: what interruption takes<br><span class="jt-drawer-summary">Together, poem, song, and theatre read as one struggle over who stands behind the music.</span>
...
>
> *[[The Interview]]* turns that sequencing power into theatre. In EP2 Sir Lucius stops Roy while he is performing SOL and substitutes *Not Your Homie*. In EP3 Roy says music should come from the soul and be vulnerable; Lucius answers with *Ballerina Boy*'s poor performance, *"hundreds of millions of streams,"* and the offer of *"another hit,"* then presses a banana and supplies *Welcome to the Circus*. The second interruption happens one layer earlier: a metric is made to answer a question about where music comes from.
>
> Hall of Mirrors room 81 supplies the name **Trojan Horse Program**. Roy has publicly called his bright-surface/dark-content method *"Trojan Horse music."* Read beside the song, the room title gives the interruption a vehicle: a pleasing carrier enters, delivers a payload, and controls the next beat. That join is this guide's strong reading, not a claim that the artifact secretly codes the song or that one work was composed from another.
>
...
> [!reading]- Where the songs run it<br><span class="jt-drawer-summary">Across the albums, reflection can lead to self-recognition or harden into a screen or disguise.</span>
...
>
> **Lucius Lullaby (2026)** hands you the mirror weaponized, "magic mirror, tell me what you see," where "nothing's what it seems," with the shadow holding co-artist billing on the record itself. Then [[SOL]], the wordless track the album structurally ends on, voids the whole axis: no I, no you, only breath.
>
...
> [!reading]- Count every I and every you<br><span class="jt-drawer-summary">“You” drains out of Lucius Lullaby while “I” barely moves, which reads as the other leaving.</span>
...
>
> There's a reason the "you" in these songs never quite sits still, and it isn't sloppiness. If "we're all really mirrors to each other," the second person is always also the first; a song is a mirror the listener sees themselves in, not a self-portrait. One guard, though: that never collapses into "every encounter is only projection." Another person can show you what you didn't already have, and stay stubbornly other. See [[The Speaker Problem]].
>
...
> [!mask]- The moon was never his<br><span class="jt-drawer-summary">What matters is whether reflection serves its source, not who owns the moon.</span>
> The [[Albums & Eras/Singles & EPs/Ballerina Boy|Ballerina Boy]] standalone release (June 2025) ends on an older, motherly voice: "the moon reminds us that even in the darkness there is light." The moon does not generate light. It reflects it. That single line reframes the whole antagonist: Lucius isn't darkness, he's reflected light under distortion. Lit by fear, shame, and the algorithm, he throws those back; lit by the heart, he could become reminder, witness, relay. He is the reflection mistaking itself for the source, and that is his tragedy, not his crime.
>
> Watch the tell that keeps the reading honest. Moths steer by the light of the night sky, the moon and stars, and a flame close by hijacks that instinct. In his public moth speech Lucius pictures a moth that mistakes a flame for a mating call and flies into it, and his answer is a shrug about the moth population; he never once describes the moon. In this guide's reading that flame is his replacement system, a counterfeit light set where the moon should be. The danger he names is real. The moon was never his, and it is nobody's: no character owns a celestial body, and Roy, [[Characters/Stars/Mary|Mary]] and Lucius each take up the moon's role at times. When Roy does, he shows its *way of working* (receiving, reflecting, remembering); Mary most clearly carries its care; and the song that names both bodies has them **singing together**, so restoration reads as relationship, not promotion. In this guide's map, Roy is linked to the heart and Lucius to the mind.
>
...
> [!lore]- One forgetting, many costumes<br><span class="jt-drawer-summary">Many conflicts read as one danger: an image replacing what gives it life.</span>
...
>
> Is there a missing feminine light-pole? The light-creation pole is conspicuously under-personified, and Roy reads more like the human in the middle of the polarity than the light-pole itself. The blank stays open, and we don't fill it with a name.
>
> And is the master key partly an artifact of single-sourcing? Three agreeing pages ([[The Mirror]], this one, Lucius-as-usurping-reflection) may be one idea restated three times, which looks like corroboration and isn't. The Hall of Mirrors namesake grounds the motif, not the mechanism.
...
>
> Framework, attributed to its traditions and held loosely: the sun-and-moon architecture, the vessels, the cave, the mirror stage, all one floor down in [[Source vs Reflection — The Deep End]].
>
