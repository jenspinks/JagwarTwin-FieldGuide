...
An unreleased recording filed under *"Concealed Generations,"* the drawer of Roy's personal demos. It is self-keyed: the unlock code is simply its own title. The recording has since been transcribed by ear, and it turns out not to be a song at all. It is a conversation. An unnamed man describes wanting to be *"special and unique … and elite,"* and Roy answers with a plain account of his own motive: *"It was that exact drive of wanting people to think I was great, or for girls to like me … And I feel like that's how I got so lost and didn't ever really make it, because that was the drive."*

Then he turns the title over. Going to space, he says, not to prove that he could, but *"so other people could go to space too — for humanity to believe that we could do something great if we all put our minds together."* So the title is not a joke at the billionaires' expense. It is the figure Roy uses to separate ambition that performs from ambition that serves, and he is examining himself with it. Its image twin, keyed by *"in my fathers shoes,"* supplies the inheritance; this half names what the inheritance was spent on.
**Connects to →** [[Hall of Mirrors]] · [[Roy]]
...
An unreleased demo, *House of Spells (Cuz_idea)*, filed under *"Concealed Generations"* with the rest of the archival material, and self-keyed like its neighbors: the code is just the title. The parenthetical *"Cuz_idea"* reads as a working-title scrawl, a raw idea, plausibly one made with or sparked by a cousin (*"cuz"*), which marks this as an unpolished sketch rather than a finished track. The recording itself has since been transcribed by ear, and it is not simply archival. Children's voices and owl calls surround a run of identity questions — *"If my words cast a spell / And every thought comes true / Who am I? / Who are you?"* — and then the song names the head as an elevator, descends eight floors, and finds a fire escape from the house of spells.

That makes it an interior route, performed rather than described. It moves from thoughts affecting the world, to a question about who is asking, to the head as vertical machinery, to a way out. It belongs beside *Sense Hierarchy*, where a layered structure sits inside a head, and *Thought Forms*, where mental activity gives things their apparent shape — a stronger kinship than a shared owl, because each makes the inside of a mind consequential for what is experienced. The eight floors do not by themselves name a station, the lyric never says where the elevator stops, and an escape route is not a completed initiation. The recording gives the problem a voice without resolving its map.
