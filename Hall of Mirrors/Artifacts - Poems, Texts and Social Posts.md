...
A dim bedside photo, casual as a late-night phone snap: an open journal beside a pen, a dripping beeswax candle in a blue dish, a hair tie, a glass globe lamp, and a small brass deity oil lamp (a little altar, in keeping with Roy's Eastern-spiritual leanings). The journal carries two handwritten lines: *"Does ANY one understand ME?"* and *"Standing at the top the the tower of ~~[scribbled out]~~ ?"*, the destination deliberately blacked out, leaving only a question mark. The obliterated word teases a tower-of-Babel reading, though since it is genuinely illegible, that stays a guess. Dated 2014, this is Roy English in the struggling pre-Jagwar years, and its filing among the *"past selves"* frames it as a ghost of the younger, unheard version of him. The code `J403` is a cell coordinate on the *"I'm 33"* board, a map reference rather than a phrase.
