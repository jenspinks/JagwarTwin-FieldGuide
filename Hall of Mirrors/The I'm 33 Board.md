...
*"Guardian at the Gate"* isn't only a Campbell beat; the board mints two threshold-images. **The City of the Pyramids** has a real Thelemic/Crowley framework behind its title: a realm beyond the Abyss where the aspirant surrenders separate name and mastery and becomes dust. That tradition is a counter-reading to easy survival — it does not promise that the same form returns carrying its experience — and no direct receipt yet proves Roy's route to the title. Roy's sheet itself draws *"Abyss (knowledge is relation)"* between 3 and 4 and asks for the sacrifice of lesser aspects. **The Gate of the World** gives threshold a physical doorway. Reading the two beside the hopscotch question *"How to Live Forever?"* and the cracked egg is a strong guide relation `[W]`, not the artifacts' settled answer. Both are catalogued in [[Artifacts - Concept Images and Emblems]].
