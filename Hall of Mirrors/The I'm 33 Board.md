...
You expect a to-do list. You get a **wall.** Hundreds of cells: gematria tables, hand-drawn angels, the Kybalion copied out by hand, a telescope photo of the sun, a museum placard, completed-Lambda diagrams descended from Plato's *Timaeus*, brain scans, a mushroom cloud, and — for reasons that eventually make sense — a kangaroo in a hoodie. A man has sat down to reverse-engineer his own soul in Google Sheets so that, in theory, he can back it up to the cloud.

It should be the world's most elaborate cry for help. Instead it's a **cosmology** — a single, obsessively cross-referenced theory of everything, claiming one Pattern that runs *"from a solar system down to the atom,"* welded together out of the Kybalion, [[Alice Bailey]], Walter Russell, Kabbalah, [[Carl Jung|Jung]] and Plato, and then quietly wired into every song he's put out since.
...
> **A neat trick:** a good chunk of the **[[Hall of Mirrors]]** artifacts are *this board's own diagrams, minted one at a time* — the Eye of Horus, the Platonic Lambda, the Lightning Flash, "[[Artifacts - Gallery 1 (1-37)#18 · Tree Thinking|Tree Thinking]]." Part of the maze is just Roy framing his own homework. See [[Artifacts - Drawings and Sketches]].
...
The **"Body Part Stages"** cell maps the ten rungs straight onto anatomy: **feet → guts → arms → Heart (rung 5, dead center) → throat → head → crown (10).** The Heart sits at the middle of the human the way the sun sits at the middle of the board — and the throat, the *utterance gate,* comes right after it. This is also, quietly, the decoder ring for the Hall of Mirrors' stranger codes: *"teeth of a whale," "left hip of a dove."* And the decoding is sharper than it first looked. The animals count **down** from the source — swan 1, owl 2, whale 3, on to rabbit 10 at the World — while the body counts **up** from the ground, feet 1 to crown 10. They are the same ten stations addressed from opposite ends, which is why every one of those strange phrases has two numbers that add to eleven: whale 3 with the head at 8, dove 7 with the left hip at 4, horse 5 with the right shoulder at 6. *"Left hip of a dove"* is not a surreal collage of two things. It is one place, named from above and from below at once — a coordinate, with its own checksum built in.
...
Because six encodings apparently still wasn't enough, the board also draws the climb as a **hopscotch court** (*"How to Live Forever?"* — Earth at 1, Heaven at 9, a tiny haloed figure at the top) and as a **Hero's Journey wheel** with all the Campbell stops: *Ordinary World, Rabbit Hole, [[Symbols/The Fool|The Fool]], Guardian at the Gate, Belly of the Whale…* If *"Rabbit Hole / The Fool / Guardian at the Gate"* rings a bell, it's because that's the exact vocabulary of the [[Sir Rabbit]] dream in **[[Good Time (1-08)]]**.
...
*"Guardian at the Gate"* isn't only a Campbell beat; the board mints two threshold-images. **The City of the Pyramids** has a real Thelemic/Crowley framework behind its title: a realm beyond the Abyss where the aspirant surrenders separate name and mastery and becomes dust. That tradition is a counter-reading to easy survival, since it does not promise that the same form returns carrying its experience, and no direct receipt yet proves Roy's route to the title. Roy's sheet itself draws *"Abyss (knowledge is relation)"* between 3 and 4 and asks for the sacrifice of lesser aspects. **The Gate of the World** gives threshold a physical doorway. Reading the two beside the hopscotch question *"How to Live Forever?"* and the cracked egg is a strong guide relation, not the artifacts' settled answer. Both are catalogued in [[Artifacts - Concept Images and Emblems]].
...
A stepped diagram with **ten numbered stations but eleven articulated compartments**: the unnumbered `3 | 4` chamber sits between the numbered bands, *"Abyss In"* and *"Abyss Out"* mark two different interfaces, and station 10 stands as a separate base. A Da'at comparison is available only as a tentative Tree-of-Life reading; the drawing does not name Da'at or reduce its two Abysses to one hidden point. This region of the larger *GNOTHI SEAUTON* page quietly became a collectible. (The full artifact breakdown lives in [[Artifacts - Drawings and Sketches]].)
...
The board places four fraction equations around the **Eye of Horus**; the six sense labels — smell, sight, thought, hearing, taste, and touch — are written on the separate [[Artifacts - Gallery 3 (75-112)#88 · Complete Upload Recipe|Complete Upload Recipe]]. Its fractions sum to **63/64**, and touch is explicitly the final 1/64. The remainder is unnamed. A modern story that assigns Eye parts to senses and has Thoth restore a missing piece is widely repeated but historically contested. The useful digital-double question survives the correction: does a complete-looking inventory preserve the relation that makes a self alive?
...
A later completed **Lambda** built from the seven boundary quantities in Plato's *Timaeus* — powers of two down one leg, powers of three down the other, with their means inserted between them. Plato supplies the numbers and interval-filling operation; he does not draw this finished ten-node triangle, and the figure is not the full Lambdoma matrix. Across each completed row the two legs meet at 3:2, the perfect fifth. The universe, tuned, is the page's invitation; reading it as the poem's *"One into many"* is this guide's comparison.
...
These are adjacent stages in a routed ascent, not two independent pictures of forbidden architecture. **Ros Tau** (Rostau) names the Giza-necropolis threshold in the Egyptian register, while **51.843** supplies the route's Great-Pyramid angle. The next artifact is titled **[[Artifacts - Gallery 3 (75-112)#93 · FORBIDDEN CITY|Forbidden City]]**, but it does not depict Beijing: it is a direct crop of the larger KHAWAH sheet's completed-Lambda / *World Soul* number drawing. Its code is `ROS TAU`, so the Egyptian name becomes the literal key into a mountain of number with **1** at its summit. The grounded sequence is `HIGHER RESOLVE` → `51.843` → `ROS TAU` → `FORBIDDEN CITY`. The title and route invite a guarded-centre or threshold reading, but Chinese architectural symbolism remains a possible resonance, not the artifact's identified visual source or documented authorial intent. In [[Artifacts - Ciphers and Code-Series]] and [[Artifacts - Concept Images and Emblems]].

### And then, because he doesn't do things by halves
For completeness, the science wall also includes Walter Russell's *"octave numbers,"* continued fractions of φ and √2, a Fibonacci spiral, a Lo Shu magic square, the [[Carl Jung|Jung]] psyche-map (*Persona / Shadow / Self*), and the Kabbalistic veils (*Ain Soph, Ain*). That Jung map, plus *"One become Two,"* plus a left-brain/right-brain split, is more or less the blueprint for **[[Sir Lucius]]** — the shadow was drawn as a diagram years before he was ever cast as a character.
...
Three of those "for completeness" diagrams got minted too, and each is sneakier than it looks. **[[Artifacts - Gallery 4 (113-149)#120 · FIBONACCI RABBITS|Fibonacci Rabbits]]** is the golden ratio drawn from its original prompt (*breeding rabbits*), which means the most beautiful proportion in nature is really a formula for **generation:** the *"make more eggs"* thesis with a spiral on top. **[[Artifacts - Gallery 3 (75-112)#112 · SATURN MAGIC|Saturn Magic]]** overlays four distinct layers on one 3×3 field: a played tic-tac-toe game, the Chinese Lo Shu square, its Renaissance planetary reception as Saturn's kamea and seal, and a Carroll code, `AN AGED AGED MAN`. Saturn-as-Father-Time is a strong rhyme, not proof of the diagram's source. **Wheels** draws three concentric rings labelled `AIN`, `AIN SOPH`, and `AIN SOPH AUR` beside the Theosophical phrase *"Ring Pass-Not."* The code *"there are things behind things"* fits the nested form, but the title alone does not turn it into Ezekiel's chariot or make those historical vocabularies one ancient system. All three live in [[Artifacts - Concept Images and Emblems]].
...
Pasted across the board are photographs, and they aren't random — they're the theory in pictures. The **sun** and an upside-down **golden tree** (emanation). A **sperm and egg,** **cell** micrographs, **tardigrades** (generation — the *"I'm an egg"* thesis, again). A **mushroom cloud** parked right next to the note *"unbalance explodes itself like an atom bomb."* A neon **Vitruvian man with a split brain,** Michelangelo's **Creation of Adam,** the gold-ground ***Ladder of Divine Ascent*** (the monastic icon associated with John Climacus, where demons hook climbers off the rungs), and a **separate William Blake *Jacob's Ladder, or Jacob's Dream*** (Genesis 28: a spiral stair of figures moving both ways from the sleeping Jacob toward the sun). The board carries both ascent under attack and ascent as received exchange. A *2001* **monolith** and the **ouroboros** continue the *as-above-so-below* argument assembled out of stock imagery. Even the magazine covers (*LIFE*'s "Jesus," "Harry Potter — 25 Years of Magic") are quietly part of the canon he's pulling from.
...
Roy keeps a private **bestiary**, one animal per planet, and nearly the whole menagerie got minted, with the planets named right in the captions. **Jupiter** draws a **dolphin** (the jovial giant, the friendliest mind in the sea), and a horse named **Cinnamon** is tagged *"Trojan Horse Program"*: the gift-animal with something hidden inside, which is the upload, or the algorithm, or [[Sir Lucius]], depending on the day you ask. It's the same instinct that handed Mercury the [[The Crow|crow]] and Venus the [[The Dove|dove]]: the cosmos mapped onto creatures so it can be *felt* rather than merely charted. It also decodes the maze's odder body-part codes. *"Teeth of a whale," "left hip of a dove":* if every planet is a beast, the whole sky is one enormous animal, and [[#The Ascent Ladder|the ladder tab]] is its skeleton. The whale (*"GOD the Mother on Saturn,"* breaching over the *"Great Sea"*), *"[[Artifacts - Gallery 3 (75-112)#79 · Venus the Dove (w/ Lamp)|Venus the Dove]],"* *"[[Artifacts - Gallery 1 (1-37)#34 · Michael the Fox|Michael the Fox]]"* with the ☿ glyph in his paws, and *"Enoch the imaginary Swan"* hang with these two in [[Artifacts - Drawings and Sketches]], while *"[[Artifacts - Gallery 2 (38-74)#76 · THE GATE OF THE WORLD|Lemon the Rabbit]] (at the Gate of the World)"* holds the ladder's ground floor in [[Artifacts - Concept Images and Emblems]].

### "Statue of Roy"
Here's the board being funny and sincere in the same breath. Roy pastes in a museum placard for an ancient namesake: Roma, also rendered Roy, a High Priest of **Amun** at Thebes. The source statue holds a Hathor-headed sistrum, tying the office to ritual music; TT283 is the designation of Roma's tomb, not a spreadsheet coordinate or a place-name. The [British Museum's statue of Roy](https://www.britishmuseum.org/collection/object/Y_EA81) gives the survival claim a firmer floor: its inscription asks that his statue and name remain in the temple.

The board keeps an ancient priest's name beside a modern singer's. Recognition, preservation, and voice are all available readings of that choice. It is not evidence that Roy is literally the priest, and *High Priest of Amun* should not be silently turned into *sun-priest of Ra* for a cleaner SOL connection.
...
The placard material became three artifacts, and their names and keys chain into a closed loop: **[[Artifacts - Gallery 1 (1-37)#33 · ROMA CALLED ROY|Roma Called Roy]] → [[Artifacts - Gallery 2 (38-74)#43 · TRUE VOICE|True Voice]] → R1045 → back to Roma.** The loop securely joins an ancient namesake, the funerary epithet *maa-kheru* (*true of voice* or *justified*), and a spreadsheet cell code. The hieroglyph strips have not yet been securely transcribed, and the modern-Roy-equals-ancient-Roy claim remains an interpretation of the juxtaposition, not a fact delivered by the source. All three are in [[Artifacts - Ciphers and Code-Series]].

### The receipts on the artist
The board is also, sneakily, a scrapbook: an **EYE ALASKA** poster (Roy's pre–Jagwar Twin band), live and studio shots, a TV segment or two, a Polaroid dated *"Ashwood 2/18/14,"* an address tagged *"3233."* And two lines that explain more than the gematria does: his mom's *"He who plants a seed believes in God,"* and a flat little note about getting **dropped by the label.** The seed-faith and the wound, in the same handwriting as the cosmos.
