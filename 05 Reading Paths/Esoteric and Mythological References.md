...
> **The thread.** The older traditions the work actually studies — kept in front as readings, never passed off as fact.

Underneath the songs runs a current of esoteric and mythological material: Kabbalah, Gnosticism, Hermeticism, the labors of a Greek hero, the figure who carries a disorienting light. Some of it Roy demonstrably studies; some of it the work simply participates in. This path names the traditions in the order they build on each other and ends on a single symbol where the whole current surfaces. Take it if you want the sources behind the symbolism — handled honestly, as interpretation.
