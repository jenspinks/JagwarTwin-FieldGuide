...
title: Roy's Tattoos
type: reference
cssclasses: ["type-reference"]
status: published
confidence: mixed
source_basis: ["public posts", "public interviews", "official videos"]
---
# Roy's Tattoos
...
- an **[[Hermeticism - As Above So Below|"as above, so below"]]** object — the Kybalion's Correspondence principle, which he transcribes by hand on his public *"[[The I'm 33 Board|I'm 33]]"* board, here enacted on flesh;
...
- **`ROSE ESOR`** — directly under the `+`. *rose* mirrored into *esor* — a palindrome wrapped around the cross (the **Rosy Cross**; see [[The Rose]]).
...
- *…Functions like Prayer in Reverse* — inked beneath *FEAR*.
- `///` (neck) — *"the three tally marks remind me of the Power of Three."*
...
- [[The I'm 33 Board]] — the same cosmology, drawn on a board instead of skin.
