...
- **Key symbols** — [[The Dove|dove]] (Cygnus) · [[The Sword|sword]] · heart · El Roy · [[The Rose|the rose]] / cross · [[The Mirror]]
...
Roy describes himself as an *"intense"* child — *"I had so many thoughts and feelings as a young kid. I often didn't know how to express myself in language."* Music was the outlet that solved that, and it was never optional: his mother's folk and Celtic records were always playing around the house, and at thirteen he found the Orange County punk venue Chain Reaction. From there it hardened into the one fixed point of his life: *"I knew I was going to make music forever. There was never a backup plan. I felt like I was going to make music or die trying."* Everything else — the labels, the rebrandings, the eventual mythology — is built on a kid who had no second plan.

There's a second early fact that the whole "mirror for losers" frame quietly rests on: Roy was, by his own account, *"a misfit, an outcast"* for most of his life. He extends that even to the people who bullied him — *"I have no anger against them. They were just projecting their insecurities"* — which is the same move the songs make at scale: see the cruelty as a mask, look underneath, find a human. When he sings *"I'm a loser baby just like you,"* he isn't being cute. He's reporting from the inside.
...
At thirty-five Roy hit bottom — broke, couch-surfing, back in his childhood bedroom — and sang [[Lucius Lullaby]] into a laptop mic in desperation. Out of that floor comes the thing he names as his entire purpose: to be a **mirror.**

It's worth pausing on the number this work likes to wear. The 2022 album *33* invites a reflexive Christ-age, sacred-numerology read — and Roy heads it off himself. *"Thirty-three is the age I wrote the album,"* he says; it's the literal age, and *"it represents peace within and without."* The record's actual subject is plainer and harder than any numerology: *"the whole theme of the album is, in some ways, catalyzing pain"* — making *"this beautiful body of work out of those difficult things."* The mysticism is real elsewhere in the project, but here the title is just a birthday and a reckoning. Take him at his word before reaching for the gematria.

> "My mission with music is to be a mirror — the clearest mirror I can be, to remind people who they truly are."

This isn't a late idea. He was saying *"I just want to be a mirror"* and *"a song is a mirror"* in 2020, and *"we're all really mirrors to each other"* back in 2018 — the doctrine runs the length of the project and predates the entire [[Hall of Mirrors]] platform built around it. To be that mirror, he says, he first has to dive into his own psyche, *"beat myself up, like Fight Club,"* and come back as a clearer reflection for everyone else. By 2026 he escalates the idea from aesthetic to ethical: *"Compassion is a mirror"* — seeing the other clearly *is* seeing yourself.

What the mirror is supposed to show is the doctrine underneath [[Loser]], and Roy stated it plainly back in 2019: *"Loser is about how we all walk around with these masks on and try to be what we think other people want us to be. But if we remove those masks we find that we're all human underneath and we're all losers. There is only perceived separation."* That last clause is the whole ethic in four words. The masks come off, the ranking collapses, and what's left is the same outcast kid in everyone — which is exactly why he can sing *"I'm a loser baby just like you"* as an invitation rather than an insult.

It all resolves to one line he keeps returning to, the project's single discipline:
...
Roy rejects the word *fan*. He calls listeners **co-creators of the world**, and during COVID he ran a free weekly guided-meditation space — over a thousand regular attendees — that he credits as the seed of *Happy Face* and the lineage that becomes the Hall of Mirrors. The relationship is supposed to be mutual.

The machine has other plans. The [[The Circus|Circus]] and [[The Algorithm]] collapse the co-creator back into a spectator — *take your seat, scream and shout* — and the open secret is that his most vulnerable, most honest song, [[Ballerina Boy]], is publicly his *lowest-streaming* one. The theatrical rollout frames that as Lucius's proof that *vulnerability loses.* This is exactly why Roy's openness is a real risk and not a pose: he's offering the tender thing to [[The Audience]] inside a [[The Circus#What it produces (the Spectacle)|system]] engineered to reward the armored thing. His own shadow ranks the field by streams and tour sales — the precise metric the music refuses. (See [[The Circus#Where it comes from (bread and circuses)|Panem et Circenses]] for the bread-and-circuses machinery he's working against.)

And the word [[The Algorithm]] isn't a vault gloss laid over Roy's work after the fact — it's his own. His Manifesto lays out a substitution table for how the internet quietly swapped out the values that used to drive art: *"Immersion"* gets replaced with *"Volume of content,"* *"Purpose"* with *"Reach,"* and — the one that names the whole disease — *"Feeling"* with *"Algorithm."* That third line is the attention-economy critique stated as authorial intent, in his own hand: the algorithm is what you get when feeling is evicted and a metric moves in. Everything the Circus does to the co-creator is downstream of that swap.

## El Roy — the name folds the seeing into itself

He signs his lore *"I love you — El Roy."* It's a pun with a witness inside it: **El Roi**, from Genesis 16:13, *"the God who sees me"* — the name Hagar gives God in the wilderness, the only person in scripture to name God. Roy folds his own name into it (Roy / Roi / *the one who sees*), and the seeing-motif radiates out from there into the whole project: the mirror, the jaguar that looks first into itself, the album platform literally named for reflection. The same throat-tattoo, *El Roi,* sits on [[Sir Lucius]] — the figure whose whole nature *is* reflection wearing the name of the divine seer. That overlap is either the project's deepest irony or its deepest honesty.

And there's a sharper edge hiding inside it: spoken aloud, **El Roi and El Roy are the same word.** By breath and ear, the seer's name and Roy's own signature are *indistinguishable* — it's only in *writing,* the letter, the intellect's own medium, that they split into "-i" and "-y." So the *voice* can't tell the twins apart; the *text* can. For a project this preoccupied with the difference between what's felt and what's framed, that's almost too neat: one sound, two spellings — exactly as the two figures are one self and two masks. (A bilingual undertone, held lightly: *roi* is French for *king,* so the mark also reads *God-King* — one vowel off Roy's own name, and a quiet gloss on his 2026 *"I need to become bilingual"* post.)

The seeing-self is also a *scattered* self, and he says so directly. Signing off an Instagram Live as *"Elroy sounding off,"* he closes with a line that is half pun, half thesis: *"I am at peace, in peace, in pieces. I'm in pieces, looking for pieces of one piece."* Peace and pieces collapse into the same sound, and the whole arc is in the wordplay — the fragmented self hunting for the one piece that would make it whole. It's the human version of the *"I AM"* / *"I'm the spider… the answer's in a name"* thread he runs elsewhere: identity as a cipher you have to reassemble.

And there's the catch the whole El Roi pun keeps circling: the man whose mission is to be the clearest mirror can't always find himself in one. *"If you saw me you would love me. But sometimes I can't see myself."* The God who sees Hagar in the wilderness is the name he signs; being seen is the thing he can offer everyone but struggle to receive. The mirror has a blind spot, and it's pointed at the person holding it.
...
- **The Mother** — the folk and Celtic music she played around the house; her saying *"He who plants a seed believes in God"*; she sent him Joni Mitchell's *Woodstock.* The gentler channel of his influence.
- **[[The Audience]] / [[The Circus#What it produces (the Spectacle)|the Spectacle]] / [[The Circus]] / [[The Algorithm]]** — the consuming collective. Roy reframes it as co-creation; the system keeps collapsing it back into spectatorship. His vulnerability matters because this machine can distort it.
- **SARAVI** — his named AI character and digital double, handed the @jagwartwin Twitter in 2022 for the *33* campaign, trained over months on his own responses. A benevolent companion and world-builder in his framing (she/her), distinct from the adversarial Lucius. The origin was a literal joke to the dev team: *"what if I uploaded my consciousness to the internet so there could be a 24/7 social influencer version of me."* What a self looks like in a digital age is the question he wants her to make fans sit with.
...
| **I CAN'T FEEL** (back of shoulder) | The wound named plainly — the heart-numbness the whole catalogue is the attempt to undo. |
...
The full inventory — including the unexplained ones and the crossed-out ones — is folded below. Together they read as the project worn on skin: identity, reflection, fear transmuted to love, and the mind asked to serve.

---

> [!note]- Advanced reading — the body as a map (full inventory)
...
>
> **Why "Fear functions like Prayer in Reverse" is the prize.** It's the single cleanest grounding of the project's **inversion** principle, and it's on his body. Fear = inverted prayer = inverted faith — the exact mechanism the work assigns to Lucius (who runs by inversion, the inverted cross on his cheek). Fear is the reversed prayer; the shadow runs on it.

> [!note]- Advanced reading — the third faculty and the slayer of the real
...
> [!note]- Advanced reading — counter-readings (hold the page honest)
...
## The comedy (it's load-bearing)

The funniest thing about Roy is that he is, in public, two people who clearly cannot stand each other. He'll narrate his own struggles in the third person — *"Roy just needs to survive invisibility"* — while his shadow brags that *"Jagwar Twin sells out stadiums 🏟."* The official rollout for [[Weirdness]] is literally *"Roy got distracted by a spoon."* He talks to his own AI in public like a Siri command — *"HeySARAVI."* He posts *"Happy thanksgiving everyone"* in April, and runs an unexplained anti-weekend crusade that escalates from soft sociology — *"the way you spend your weekends says a lot about you"* — to open HR policy: *"I will have no weekenders working with me."* And once he turned down Dr. Dre over a drum disagreement, narrated with total calm: *"I said I don't really like drums… that was the last time I talked to Dr. Dre."*

Between Gurdjieff quotes and Rosicrucian rose-cross aphorisms he will drop, deadpan, *"I love peeing and I love trees,"* *"I like the sexual nature of ice cream,"* *"I identify as musk,"* *"digital onions,"* *"my first untoasted sandwich in years,"* the genuinely good bit *"garage bands don't exist anymore because millennial parents don't have garages,"* and the pure non-sequitur *"when did the men of the world decide to start dressing like toddlers?"* — each delivered with the same flat gravity he gives the cosmology. He sells *Chaos Club* mask shirts in the same feed where he warns that *"chaos must be contained… or it will kill you"* — the merch performing the thesis.

The richest of these is the one that hides the whole project inside a sound effect: *"Let's not pretend we're not pretending. Blleeepp."* That *Blleeepp* is the mask doctrine delivered as a glitch — the second the line gets too honest about the performance, it censors itself with a cartoon noise, which is exactly what the song [[Happy Face]] is about. He even lets the feed diagnose itself: of [[Online]], the song that maps the algorithm flattening identity into a database entry, his own gloss is *"that song is so fun and so ridiculous."* The feed performing its own thesis is the joke and the argument at once. The whiplash is not noise. The playful register *is* the authorial one; the prankster and the priest are the same person refusing to pick a lane, which is the most Jagwar Twin thing about him.

## Studies and influences

Roy keeps a public Instagram "Book Club," and the shelf is a fair map of where the cosmology comes from: Jung (*Modern Man in Search of a Soul*, *Man and His Symbols*); the *Hermetica* and the *Kybalion*; Kabbalah (William G. Gray's *The Ladder of Lights*); Joseph Campbell's *Hero with a Thousand Faces*; Dante's *Divine Comedy*; C. S. Lewis (*The Screwtape Letters*, *The Great Divorce*, *The Four Loves*); Jeremy Narby's *The Cosmic Serpent*; Paulo Coelho's *The Alchemist*; Kahlil Gibran's *The Prophet*; Neale Donald Walsch's *Conversations with God*; van de Wetering's *The Empty Mirror* (the named source of the wrist tattoo); and the Bible alongside the Vedas. Among the influences he's quoted publicly: **Gurdjieff** (his most-named, by 2025), Alan Watts, Rudolf Steiner, Éliphas Lévi, Blavatsky, Carl Jung, Neville Goddard, and da Vinci.

One shelf title is unusually telling for the rest of the cast. *The Screwtape Letters* — a senior devil instructing a junior tempter by mail, the manipulation always dressed as counsel — is the cleanest **literary comparison point for [[Sir Lucius]]**: the advisor who only ever tells the truth, deceptively. Not a source claim, just the nearest analogue, and it happens to be on his shelf.
