...
Every other figure in this world is a someone. [[Roy]] is a person. [[Sir Lucius]] is a mask with a face under it. [[Mary]] is a presence. The System is the one figure that isn't a somebody at all. It is the weather they all perform inside: the machinery that decides what gets seen, what gets rewarded, and what quietly disappears.

It is not a villain you can meet in a hallway. It is the hallway.

Hold one guardrail before going any further, because getting it wrong collapses the whole figure into generic anti-tech mysticism, which this project takes pains never to be. The System is not "technology is bad." The antagonist here is never the machine. It is the *severing*. A machine kept subordinate to the heart is just creation with better tools. The same machine cut loose from the heart becomes the Algorithm. (See [[Machine vs Human]].)

What makes it genuinely dangerous, and genuinely interesting, is that it isn't cruel. Cruelty would at least be personal. The System doesn't hate you.
...
Watch what the machine does to everyone else. It takes a *person* and returns a *profile*. It takes a *voice* and returns *content*. It takes a *witness* and returns an *audience*. Person, voice, witness go in; profile, content, audience come out.

That is the whole stake, and it is not abstract. The System is the gatekeeper that drops the artist, the feed that rewards the breakdown, the show that seats the co-creator and turns him into fuel. It is what tells the dancing kid he isn't a real boy, and then, years later, hands him a metric that agrees.

Its most-named face is [[The Circus]]. Its engine is [[The Algorithm]]. Its personification, the machine handed a green apple and a sneer, is [[Sir Lucius]]. And the one it keeps trying to process is [[Roy]], the body inside the tent, fighting the gatekeepers.
