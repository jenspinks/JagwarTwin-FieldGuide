...
A machine kept subordinate to the heart is just creation using tools. The same machine cut loose from the heart becomes the Algorithm. As Above So Below, my robot freaks. You aren't off the hook just because you are exempt from bodily fluids.(See [[Machine vs Human]].)
...
> - **Diagnosis without a cure?** Does the project name the disease without prescribing the exit, the way Juvenal diagnosed *panem et circenses* but never told Rome how to get free, or is the way out also named? The [[The Realm]] and the [[The Loop and the Circle|Circle]] gesture at an answer; whether they *escape* the System or just govern a better corner of it is itself unresolved.
