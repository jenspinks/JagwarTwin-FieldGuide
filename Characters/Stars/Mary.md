...
> - **Is Mary Ariadne, the thread-bearer?** In the project's vocabulary the thread you follow through the dark is the heart, the feeling-line through the labyrinth (see [[The Thread]]). And a finer fork under it: is the thread *given* (handed to you by Mary / the divine) or *held* (your own refusal to sacrifice feeling)? Probably both, but which the work emphasizes changes the whole agency model.
