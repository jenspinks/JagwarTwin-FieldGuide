...
Here is the keystone, and it is grounded in Roy's own voice. [[Sir Lucius]] is not an outside villain. He is Roy's rational mind when it becomes untethered from the heart, and Roy frames that danger in almost theological terms:
...
<img src="https://plumcreekranch.com/jagwar/tattoos1.jpeg" style="float: right; width: 165px; margin-left: 16px; margin-bottom: 8px;">Roy's body is a wearable version of the cosmology. The structural fact, in his own words: **every tattoo is inked on the right side and mirrored onto the left, and one `+` sits in the center, spanning both sides.** The body is not a list of tattoos. It is a *symmetrical diagram* with a central axis.

A few of the load-bearing ones are below. The **full inventory,** every mark, his own glosses, and where each is sourced, is folded at the bottom of this page and on **[[Roy's Tattoos]]**. One honest caveat before the table: these are compiled from his own spoken glosses, and exact wording and placement are still pending photo-confirmation, so treat the quotes as close-but-unconfirmed rather than gospel.
...
> [!reading]- Three's Company (and the Slayer of the Real)<br><span class="jt-drawer-summary">Roy's own triad resolves the split upward into intuition, the mind a step, never the destination.</span>
...
> [!warning]- Devil's Advocate (Someone Has to)<br><span class="jt-drawer-summary">The frame is Roy’s own press, so the authentic self he presents may itself be authored.</span>
...
>
> **The keystone is on record. The scenes are still readings.** Roy has called Sir Lucius the mind in his own voice (*"lucius is the mind,"* on the public Discord), so that link is stated, not inferred. What it does not settle is how the doctrine plays out in a given song or scene. Those stay readings, and if I ever sound sure about one, I am doing it wrong.

> [!feed]- Feed Me, See More<br><span class="jt-drawer-summary">Roy's dated posts, in his own hand, run from images over words to artist-warrior integration.</span>
...
> [!receipts]- Source notes (the receipts)<br><span class="jt-drawer-summary">Roy's own words ground the biography, the body-map a strong reading, the Tree lenses framework.</span>
