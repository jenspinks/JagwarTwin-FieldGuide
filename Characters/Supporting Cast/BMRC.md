...
- **Grounded (production layer), staged (in-world).** BMRC = the *Black Magic Rainbow Circus*, captured from sirlucius.com and jagwartwin.com page metadata (2026-07 capture) and spelled in Roy's 🖤🪄🌈🎪 caption; on the artifacts the initials stay unexpanded, by design.
- **Strong readings.** BMRC as the industry-Babylon the Circus runs on, with Lucius as its self-styled boss (not an employee under it); the show-and-ordnance identity as a systems statement; the four captured symbols (Black, Magic, Rainbow, Circus) read as Lucius distorting Roy's signs; Leif as the structural foil.
