...
- **Grounded (statements from the project, public artifacts).** That the basic symbol map gives Roy the sword; the *discernment / chosen action* gloss is this guide's reading. The **"Flaming Sword"** artifact exists as an unlocked [[Hall of Mirrors]] piece (the Kabbalistic Lightning-Flash / Eden-gate blade).
